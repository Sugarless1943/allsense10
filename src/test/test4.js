let data = [
  ...
  {"ID":"H31","Name":"宋古换热站","Parent_ID":"P41","Type":"H","Length":"25","Diameter":"250","Cid":"1","Circuit":"H34/P44/P42/P41/H31","Standard_Uid":"b479cee0-f702-462c-afcc-dde60e1dae26","Parent_Tree":"S2","Heat_Coef":"0.6","Switch_On":"1"},
  {"ID":"H33","Name":"宋古村换热站","Parent_ID":"P43","Type":"H","Length":"490","Diameter":"250","Cid":"2","Parent_V_ID":"HJ","Circuit":"H33/P43/P91-A/P91/H105","Standard_Uid":"151f37ea-b0cf-4d33-8c23-8ecf8a4950dd","Parent_Tree":"HJ","Heat_Coef":"0.6","Switch_On":"1"},
  ...
  {"ID":"HK-1","Name":"虚拟换热站HK-1","Parent_ID":"P90","Type":"V","Length":"2160","Diameter":"600","Cid":"2","Parent_V_ID":"HK","Parent_Tree":"S2",},
  {"ID":"HK-2","Name":"虚拟换热站HK-2","Parent_ID":"P102","Type":"V","Length":"1593","Diameter":"250","Cid":"2","Parent_V_ID":"HK","Parent_Tree":"S2",},
...
data.forEach(item => {
  if(item.Type == 'H') {
    res.push( {
      "itemInfo": {
        "uid": "sd_" + item.Standard_Uid,
        "type": "smart_data",
        "label": item.Name,
        "location": item.Name.split("换")[0],
